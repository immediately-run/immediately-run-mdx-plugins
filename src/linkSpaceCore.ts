// The link-space CORE (R3-273; REPO_CONTENT_DISPATCH_SPEC §9 decision, 2026-08-17;
// moved here from the SDK by R3-279 so the S3 content-framework's first extraction —
// @immediately-run/safe-content — can consume the canon without depending on the SDK
// (the SDK would then re-export the package: a cycle). The resolver's parity fixture
// already lives here; now the canon sits beside it. The REACT parts (LinkSpaceContext,
// the provider surface) stay in the SDK — this package is pure and React-free.
//
